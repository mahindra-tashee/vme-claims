...
@Component({
  ...
  styleUrls: ['./claim-tabs.component.scss']
})
export class ClaimTabsComponent implements OnInit {
  actionList: Array<Action> = [];
  claimsDetailsLazyComp: Promise<Type<ClaimDetailsComponent>>
  documentsLazyComp: Promise<Type<DocumentsComponent>>;
    ...
    this.route.queryParams.subscribe((params) => {
      if (params['claimId'] != undefined && params['claimId'] != null && params['claimId'] != "") {
        ...
        if(this.sharedService.isClaimEdit){
          ...
          this.claimsDetailsLazyComp = import('../claim-details/claim-details.component').then(({ ClaimDetailsComponent }) => ClaimDetailsComponent);
          this.documentsLazyComp = import('../documents/documents.component').then(({ DocumentsComponent }) => DocumentsComponent);
  ...
  getClaimDataById(claimId, flag) {
    ...
    this.claimService.getApproverClaimDetailsById(claimId).subscribe((claimTabsResponse) => {
